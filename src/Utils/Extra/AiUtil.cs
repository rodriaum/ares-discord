...
public class AiUtil
{
    ...
    public static List<ChatHistoricModel> ConvertToChatHistoric(string prompt, string imageUrl = "", MessageResponse? responseAnthropic =  null, ChatResponse? responseDeepSeek = null, ChatCompletion? responseOpenAi = null, GeneratedImage? imageOpenAi = null)
    {
        List<ChatHistoricModel> historics = new List<ChatHistoricModel>();

        if (responseAnthropic != null)
        {
            historics.Add(new ChatHistoricModel
            (
                prompt: prompt,
