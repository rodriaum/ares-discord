...
/// </summary>
public class UserChatHistoricModel
{
    /// <summary>
    ...
    /// <summary>
    /// Inicializa uma nova instância da classe <see cref="UserChatHistoricModel"/>.
    /// </summary>
    ...
    public static List<UserChatHistoricModel> From(
        string prompt,
        string? imageUrl = null,
    ...
    {
        List<UserChatHistoricModel> historics = new List<UserChatHistoricModel>();

        if (responseOpenAi != null)
        {
            var contentOpenAi = responseOpenAi.Content[0];

            historics.Add(new UserChatHistoricModel
            (
                prompt: prompt,
    ...
    public static List<OpenAI.Chat.ChatMessage> ToRemote(List<UserChatHistoricModel>? historics)
    {
        ...
        foreach (UserChatHistoricModel historic in historics)
        {
    ...
    /// </summary>
    /// <param name="historics">Lista de históricos de chat armazenados.</param>
    public static List<Microsoft.Extensions.AI.ChatMessage> ToLocal(List<UserChatHistoricModel>? historics)
    {
        if (historics == null || historics.Count == 0)
        {
            return new();
