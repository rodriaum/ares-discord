...
public class GChatHistoricModel
{
    ...
    public static List<GChatHistoricModel> From(
        string prompt,
        string? imageUrl = null,
    ...
    public static List<OpenAI.Chat.ChatMessage> ToRemote(List<GChatHistoricModel>? historics)
    {
    ...
    /// </summary>
    /// <param name="historics">Lista de históricos de chat armazenados.</param>
    public static List<Microsoft.Extensions.AI.ChatMessage> ToLocal(List<GChatHistoricModel>? historics)
    {
        if (historics == null || historics.Count == 0)
        {
            return new();
